...
public class GraphDisplay {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        g.addEdge(vertices[3], vertices[3], 1);
        g.addEdge(vertices[3], vertices[6], 1);
        g.addEdge(vertices[6], vertices[6], 1);
        g.addEdge(vertices[6],vertices[6], 1);
        ...
        // }
        AbstractPlayerAlgorithm pursuer = new MoveTowardPlayerAlgorithm(g);
