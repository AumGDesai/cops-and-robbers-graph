/*
 * ExtensionDisplay.java
 * Modified from GraphDisplay.java
 * Date: May 3rd
 * 
 * Displays the modified graph
 * 
 */
...
public class ExtensionGraph {
    ...
    AbstractPlayerAlgorithm pursuer1, pursuer2, evader;
     ...
     */
    public ExtensionGraph(Graph g, int scale) throws InterruptedException {
        this(g, null, null,null, scale);
    }

    public ExtensionGraph(Graph g, AbstractPlayerAlgorithm pursuer1, AbstractPlayerAlgorithm pursuer2, AbstractPlayerAlgorithm evader, int scale)
            throws InterruptedException {
        ...
        this.pursuer1 = pursuer1;
        this.pursuer2 = pursuer2;
        this.evader = evader;
    ...
    private class LandscapePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            if ((pursuer1 != null && pursuer1.getCurrentVertex() == evader.getCurrentVertex())||(pursuer2 != null && pursuer2.getCurrentVertex() == evader.getCurrentVertex()))
            ...
            for (Vertex v : graph.getVertices()) {
                if ((pursuer1 != null && v == pursuer1.getCurrentVertex() && v == evader.getCurrentVertex()) 
                || (pursuer2 != null && v == pursuer2.getCurrentVertex() && v == evader.getCurrentVertex()))
                    g.setColor(new Color(148, 0, 211));
                else if ((pursuer1 != null && v == pursuer1.getCurrentVertex()) 
                || (pursuer2 != null && v == pursuer2.getCurrentVertex()))
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < vertexNum; i++) {
            g.addEdge(vertices[i], vertices[(i + 1) % vertexNum], 1);
        }
        ...
        // g.addEdge(vertices[3], vertices[5], 1);

        g.addEdge(vertices[1], vertices[4], 1);
        g.addEdge(vertices[1], vertices[5], 1);
        g.addEdge(vertices[4], vertices[5], 1);
        g.addEdge(vertices[2], vertices[5], 1);
        g.addEdge(vertices[2], vertices[6], 1);
        ...
        // }
        AbstractPlayerAlgorithm pursuer1 = new MoveTowardPlayerAlgorithm(g);
        AbstractPlayerAlgorithm pursuer2 = new MoveTowardPlayerAlgorithm(g);
        AbstractPlayerAlgorithm evader = new MoveAwayPlayerAlgorithm(g);
        // AbstractPlayerAlgorithm pursuer = new RandomPlayer(9);
        // AbstractPlayerAlgorithm evader = new RandomPlayer(9);
        pursuer1.chooseStart();
        pursuer2.chooseStart(pursuer1.getCurrentVertex());
        evader.chooseStart(pursuer2.getCurrentVertex());
        ExtensionGraph gd = new ExtensionGraph(g, pursuer1,pursuer2, evader, 80);
        while (pursuer1.getCurrentVertex() != evader.getCurrentVertex() || pursuer2.getCurrentVertex() != evader.getCurrentVertex() ) {
            Thread.sleep(1000);
            pursuer1.chooseNext(evader.getCurrentVertex(), pursuer2.getCurrentVertex());
            gd.repaint();
            ...
            gd.repaint();
            Thread.sleep(1000);
            pursuer2.chooseNext(evader.getCurrentVertex(),pursuer1.getCurrentVertex());
            gd.repaint();
            if (pursuer2.getCurrentVertex() == evader.getCurrentVertex())
                break;
            Thread.sleep(1000);
            evader.chooseNext(pursuer2.getCurrentVertex());
            gd.repaint();
        }
